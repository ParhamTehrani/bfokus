...
@section('content')
    <div class="container-fluid d-grid justify-content-center align-self-center align-items-center "  tabindex="-1">
        ...
        <div id="result" tabindex="0" aria-label="Get results for “{{ $search }}” with w-tap" onclick="search()" style="cursor:pointer;">
        ...
        <a href="/?search=1&lang={{ request()->get('lang') }}&provider={{ request()->get('provider') }}" tabindex="0" aria-label="Tap to voice search again"  style="cursor:pointer;display: flex;text-decoration: none"  >
