@extends('layout')
@section('content')
    <div class="container-fluid d-grid justify-content-center align-self-center align-items-center py-5" tabindex="0" aria-label="Voice Search, w-tap and say what you want to search for" id="start">
        <p style="color: white;text-align: center;font-size: 2rem" tabindex="-1">Voice Search, w-tap and say what you want to search for</p>
        ...
        <div class="d-grid justify-content-center" tabindex="-1">
            ...
            <h3 id="output" class="hide" style="color: white" tabindex="2"></h3>
        </div>
